...
namespace {
    ...
    void templatedEigenIsometry(py::module & m, const std::string & name) {
        ...
        py::class_<CLS>(m, name.c_str())
            ...
            .def("set_rotation", [](CLS& trans, RotationMatrixType& r) {
                    trans.matrix().block(0, 0, CLS::Dim, CLS::Dim) = r;
                })
            .def("set_rotation", [](CLS& trans, Eigen::Quaterniond& q) {
                    Eigen::Matrix3d r = q.toRotationMatrix();
                    trans.matrix().block(0, 0, CLS::Dim, CLS::Dim) = r;
                })

            .def("set_translation", [](CLS& trans, TranslationMatrixType& t) {
                    trans.translation() = t;
                })

            .def(py::self * py::self)

            .def("__mul__", [](CLS& trans, Eigen::Matrix<_Scalar, CLS::Dim, 1>& t) {
                    Eigen::Matrix<_Scalar, CLS::Dim, 1> result = trans * t;
                    return result;
                })
            .def("__mul__", [](CLS& trans, TranslationMatrixType& t) {
                    return trans * t;
                })
...
void declareEigenTypes(py::module & m) {
    ...
    py::class_<Eigen::Quaterniond>(m, "Quaternion")
        ...
        .def(py::init([](const Eigen::Matrix<double, 4, 1>& m) {
				//return std::unique_ptr<Eigen::Quaterniond>(new Eigen::Quaterniond(m(3,0), m(0,0), m(1,0), m(2,0)));
				return std::unique_ptr<Eigen::Quaterniond>(new Eigen::Quaterniond(m(0,0), m(1,0), m(2,0), m(3,0)));
			}))
...
//        .def("x", (double (Eigen::Quaterniond::*) () const) &Eigen::Quaterniond::x)
  ...
  //      .def("w", (double (Eigen::Quaterniond::*) () const) &Eigen::Quaterniond::w)
        ...
        .def("angular_distance", [](Eigen::Quaterniond& q1, Eigen::Quaterniond& q2) {return q1.angularDistance(q2);})
        .def(py::self * py::self)
        .def(py::self *= py::self)
        .def("inverse", &Eigen::Quaterniond::inverse)
        .def("conjugate", &Eigen::Quaterniond::conjugate)
        .def("coeffs", (Eigen::Quaterniond::Coefficients& (Eigen::Quaterniond::*) ()) &Eigen::Quaterniond::coeffs)    // x, y, z, w
	...
	py::class_<Eigen::AngleAxisd>(m, "AngleAxis")
		...
		.def("axis", (Eigen::Matrix<double, 3, 1>& (Eigen::AngleAxisd::*) ()) &Eigen::AngleAxisd::axis)
		.def(py::self * py::self)
		...
		.def("from_rotation_matrix", [](Eigen::AngleAxisd& r, const Eigen::Matrix<double, 3, 3>& R) {
				r.fromRotationMatrix(R);
			})
